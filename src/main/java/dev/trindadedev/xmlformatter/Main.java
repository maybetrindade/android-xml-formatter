package dev.trindadedev.xmlformatter;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    options.addOption(Option.builder().longOpt("indention").desc("Indention.").hasArg().build());
    options.addOption(
        Option.builder()
            .longOpt("attribute-indention")
            .desc("Indention of attributes.")
            .hasArg()
            .build());
    options.addOption(
        Option.builder()
            .longOpt("attribute-order")
